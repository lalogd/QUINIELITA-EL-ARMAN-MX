...
function selection(element){ 	//Pinta la casilla y actualiza el texto de la quiniela.
    ...
    if (!element.style.backgroundColor){
        ...
        element.style.backgroundColor = "#f60505";
    }
    else{
        if(combinations){
...
function random(){
    ...
    for (var i = 0; i < 10; i++){
        ...
        partidos[i].getElementsByTagName("span")[r].style.backgroundColor = "#f60505";
        res[i] = ["L","E","V"][r];
    }
    container.innerHTML = res.join("\xa0\xa0");
    costoactual();
...
function send(){ //Envía quiniela al whatsapp
    ...
    window.location.href = "https://wa.me/524435284266?text="+quinbara + whatsapptext;}
}
